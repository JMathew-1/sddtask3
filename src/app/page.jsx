            ...
            <div className="mx-auto grid max-w-5xl items-start gap-6 py-12 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="grid gap-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-950">
                  ...
                  <p className="mt-4 text-gray-500 dark:text-gray-400">
                    {/* Paragraph element with margin-top, text color, and color that changes in dark mode */}
                    &quot;This app has allowed me reduce the time I waste on unnecessary projects and tasks. By using the calendar and project pages, I have been able to manage my tasks and assessments.&quot;
              ...
              <div className="grid gap-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-950">
                  ...
                  <p className="mt-4 text-gray-500 dark:text-gray-400">
                    {/* Paragraph element with margin-top, text color, and color that changes in dark mode */}
                    &quot;As a busy student, this app has allowed me to schedule my assessment tasks and always stay on top of my work. This app has made planning my study sessions and projects much easier and simpler.&quot;
                  </p>
                </div>
              </div>
            </div>
